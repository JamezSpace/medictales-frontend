...
function open_page(page_to_navigate_to) {
    ...
    for (let i = 0; i < pages.length; i++) {
        ...
        if (page.classList.contains("page-active") && page.id !== page_to_navigate_to) page.classList.remove("page-active");
        else if (!page.classList.contains("page-active") && page.id === page_to_navigate_to) page.classList.add("page-active");
